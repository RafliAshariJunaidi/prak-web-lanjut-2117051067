    ...
    <div class="col-12">
      <div class="card mb-4">
        <div class="card-header pb-0">
          ...
          <?php endif; ?>
          <h6>Kelas table</h6>
          <a href="<?= base_url('kelas/create') ?>" class="btn btn-success">Tambah Data</a>
        </div>
              ...
              <tbody>
                ...
                foreach ($kelas as $kelas) { ?>
                  <tr>
                    ...
                    <td style="display: flex;margin-top:35px;" class="align-middle text-center"   >
                      <a class="btn btn-primary text-dark px-3 mb-0 mx-1  " href="<?= base_url('kelas/' . $kelas['id']) ?>"><i class="fas fa-eye text-dark me-2" aria-hidden="true"></i>Detail</a>
                      <a class="btn btn-warning text-dark px-3 mb-0 mx-1" href="<?= base_url('kelas/' . $kelas['id'] . '/edit') ?>"><i class="fas fa-pencil-alt text-dark me-2" aria-hidden="true"></i>Edit</a>
                      <form action="<?= base_url('kelas/' . $kelas['id']) ?>" method="POST">
                        <input type="hidden" name="_method" value="DELETE">
                        <?= csrf_field() ?>
                        <button class="btn btn-danger  text-dark mb-0 mx-1" style="color: red;">
